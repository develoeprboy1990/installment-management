...
<head>
    ...
    <?php if(getUserSetting('favicon')): ?>
        <link rel="icon" href="<?php echo e(getUserSetting('favicon')); ?>">
        <link rel="shortcut icon" href="<?php echo e(getUserSetting('favicon')); ?>">
    <?php endif; ?>
                        ...
                        <div class="dropdown profile-element" style="text-align: center;">
                            <span>
                                <img alt="image" class="img-circle"
                                    src="<?php echo e(getUserSetting('profile_image') ?: asset('backend/img/profile_small.jpg')); ?>"
...
<?php /**PATH /var/www/html/installment-management/resources/views/layouts/master.blade.php ENDPATH**/ ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4 custom-header">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-customers')): ?>
                <a href="<?php echo e(route('customers.create')); ?>" class="btn btn-primary custom-add-btn">Add New Customer</a>
            <?php endif; ?>
        </div>

        <?php if(session('success')): ?>
            <div class="alert alert-success custom-alert"><?php echo e(session('success')); ?></div>
        <?php endif; ?>

        <?php if(session('error')): ?>
            <div class="alert alert-danger custom-alert"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u136558562/domains/installment.mcqsmind.com/installment/resources/views/customers/index.blade.php ENDPATH**/ ?>
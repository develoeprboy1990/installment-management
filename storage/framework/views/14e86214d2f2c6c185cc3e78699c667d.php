                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><code><?php echo e($product->serial_no); ?></code></td>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-xs btn-info view-customers-btn"
                                                        data-product-id="<?php echo e($product->id); ?>" title="View Customers">
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="7" class="text-center" style="padding: 24px 0;">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-products')): ?>
                                                    <a href="<?php echo e(route('products.create')); ?>" class="btn btn-primary btn-sm">Add
                                                        First Product</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php $__env->startPush('script'); ?>
    <script>
        $(document).ready(function() {
            ...
            const baseProductUrl = "<?php echo e(url('admin/products')); ?>";
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u136558562/domains/installment.mcqsmind.com/installment/resources/views/products/index.blade.php ENDPATH**/ ?>
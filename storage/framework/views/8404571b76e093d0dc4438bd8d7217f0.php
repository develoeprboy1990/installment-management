                ...
                <div class="tab-content">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            <form action="<?php echo e(route('store.settings')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-sm-6">
                                                <?php if(!empty($settings['favicon'])): ?>
                                                    <div style="display:flex;align-items:center;gap:12px;">
                                                        <img src="<?php echo e(asset('storage/' . $settings['favicon'])); ?>" alt="Favicon" style="width:32px;height:32px;object-fit:contain;border:1px solid #e5e7eb;border-radius:4px;background:#fff;" />
                                                        <code style="background:#f7f7f7;padding:2px 6px;border-radius:4px;"><?php echo e($settings['favicon']); ?></code>
                                                    </div>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u136558562/domains/installment.mcqsmind.com/installment/resources/views/backend/settings/index.blade.php ENDPATH**/ ?>
                    ...
                    <div class="widget style1 report-widget navy-bg">
                        <div class="report-widget-body">
                            ...
                            <div class="report-widget-metrics text-right">
                                ...
                                <?php if(getUserSetting('show_total_revenue') == '1'): ?>
                    ...
                    <div class="widget style1 report-widget red-bg">
                        <div class="report-widget-body">
                            ...
                            <div class="report-widget-metrics text-right">
                                ...
                                <h2 class="font-bold"><?php echo e($data['defaulters_count'] ?? 0); ?></h2>
                                <div class="stat-percent font-bold text-white"><?php echo e(number_format($data['defaulters_amount'] ?? 0, 2)); ?> <i class="fa fa-level-down"></i></div>
                    ...
                    <!-- <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php if(isset($data['recent_payments']) && $data['recent_payments']->count() > 0): ?>
                                        <?php $__currentLoopData = $data['recent_payments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($payment->date ? Carbon\Carbon::parse($payment->date)->format('d/m/Y') : '-'); ?>

                                                </td>
                                                <td><?php echo e($payment->customer->name ?? '-'); ?></td>
                                                <td class="text-left">
                                                    <?php echo e(number_format($payment->installment_amount ?? 0, 2)); ?></td>
                    ...
                    <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                        <table class="table table-striped" id="payments_table">
                            ...
                            <tbody>
                                <?php if(isset($data['recent_payments']) && $data['recent_payments']->count() > 0): ?>
                                    <?php $__currentLoopData = $data['recent_payments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr data-date="<?php echo e($payment->date ? Carbon\Carbon::parse($payment->date)->format('Y-m-d') : ''); ?>">
                                            <td><?php echo e($payment->date ? Carbon\Carbon::parse($payment->date)->format('d/m/Y') : '-'); ?></td>
                                            <td><?php echo e($payment->customer->name ?? '-'); ?></td>
                                            <td class="text-left"><?php echo e(number_format($payment->installment_amount ?? 0, 2)); ?></td>
                                            <td><?php echo e($payment->receipt_no ?? '-'); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php if(isset($data['due_today']) && $data['due_today']->count() > 0): ?>
                                        <?php $__currentLoopData = $data['due_today']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $due): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($due->customer->name ?? '-'); ?></td>
                                                <td><?php echo e($due->due_date ? Carbon\Carbon::parse($due->due_date)->format('d/m/Y') : '-'); ?>

                                                </td>
                                                <td class="text-right">
                                                    <?php echo e(number_format($due->installment_amount ?? 0, 2)); ?></td>
                                                <td>
                                                    <span
                                                        class="label label-<?php echo e($due->status == 'paid' ? 'primary' : 'warning'); ?>">
                                                        <?php echo e(ucfirst($due->status ?? 'pending')); ?>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <table class="table table-hover no-margins">
                            ...
                            <tbody>
                                <?php if(isset($data['top_products']) && $data['top_products']->count() > 0): ?>
                                    <?php $__currentLoopData = $data['top_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-right">Rs.
                                                <?php echo e(number_format($product->total_revenue ?? 0, 2)); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <tr>
                        ...
                        <div class="text-center">
                            <div class="row">
                                <div class="col-xs-4">
                                    ...
                                    <h4><?php echo e($data['active_customers'] ?? 0); ?></h4>
                                </div>
                                <div class="col-xs-4">
                                    <small class="stats-label">Completed</small>
                                    <h4><?php echo e($data['completed_customers'] ?? 0); ?></h4>
                                </div>
                                <div class="col-xs-4">
                                    <small class="stats-label">Defaulted</small>
                                    <h4><?php echo e($data['defaulters_count'] ?? 0); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-3">
                                <a href="<?php echo e(route('customers.create')); ?>" class="btn btn-primary btn-block">
                                    <i class="fa fa-user-plus"></i> Add New Customer
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="<?php echo e(route('products.create')); ?>" class="btn btn-info btn-block">
                                    <i class="fa fa-cube"></i> Add New Product
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="<?php echo e(route('purchases.create')); ?>" class="btn btn-success btn-block">
                                    <i class="fa fa-shopping-cart"></i> New Purchase
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="<?php echo e(route('installments.index')); ?>" class="btn btn-warning btn-block">
...
<?php $__env->startPush('script'); ?>
    <script>
        $(document).ready(function() {
            // Flot Chart
            var data1 = [
                <?php if(isset($data['monthly_collections'])): ?>
                    <?php $__currentLoopData = $data['monthly_collections']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ["<?php echo e($month); ?>", <?php echo e($amount ?? 0); ?>],
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            ];
            ...
            var doughnutData = {
                ...
                datasets: [{
                    data: [<?php echo e($data['active_customers'] ?? 0); ?>,
                        <?php echo e($data['completed_customers'] ?? 0); ?>,
                        <?php echo e($data['defaulters_count'] ?? 0); ?>
            ...
            function initReportCharts() {
                ...
                if (activePieCanvas) {
                    ...
                    var a = <?php echo e((int)($data['active_customers'] ?? 0)); ?>;
                    var c = <?php echo e((int)($data['completed_customers'] ?? 0)); ?>;
                    var d = <?php echo e((int)($data['defaulters_count'] ?? 0)); ?>;
                    var n = <?php echo e((int)($data['new_customers_this_month'] ?? 0)); ?>;
                    var sum = a + c + d + n;
                    if (sum <= 0) {
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function loadMetrics(params) {
            $.get("<?php echo e(route('admin.report.metrics')); ?>", params, function(resp) {
                // KPIs
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u136558562/domains/installment.mcqsmind.com/installment/resources/views/report.blade.php ENDPATH**/ ?>